...
public class BorrowingRequestServiceImpl
    ...
    public BorrowingRequestServiceImpl(
        ...
        this.borrowingRequestRepository =
    ...
    public BorrowingRequestResponse createRequest(
        ...
        BorrowingRequest borrowingRequest =
                BorrowingRequest.builder()
                        ...
                        .maximumAcceptableApr(
                                request.maximumAcceptableApr()
                        )
                        .build();

        BorrowingRequest saved =
                borrowingRequestRepository.save(
                        borrowingRequest
                );
    ...
    public BorrowingRequestResponse getRequest(
            UUID requestId) {

        BorrowingRequest request =
                borrowingRequestRepository.findById(
                        requestId
                ).orElseThrow(
                        () -> new IllegalArgumentException(
    ...
    @Override
    @Transactional(readOnly = true)
    public List<BorrowingRequestResponse> getBorrowerRequests(
            UUID borrowerId) {
    ...
    private BorrowingRequestResponse toResponse(
            BorrowingRequest request) {
